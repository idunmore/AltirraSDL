...
// --- Input Setup dialog ---
static bool g_showInputSetup = false;
static bool g_inputSetupWasOpen = false;
static ATJoystickTransforms g_savedTransforms;
static ATJoystickTransforms g_currentTransforms;
