/*
 * 02_peek_regs.c — Phase 2 state-read example.
 *
 * Connects, advances 60 frames so the OS has booted past the
 * memo-pad screen, and prints CPU registers and a peek of the
 * Atari OS shadow keyboard buffer area ($02E0 vector RUNAD).
 *
 * Build:
