...
constexpr ATUICommand ATMakeOnCommandOptionToggle(const ATUICommandName& name, ATUICmdTestFn testFn = nullptr) {
...
constexpr ATUICommand ATMakeOnCommandOptionRadio(const ATUICommandName& name) {
	using namespace ATCommands;
