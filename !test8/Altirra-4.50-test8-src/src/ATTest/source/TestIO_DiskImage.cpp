...
void ATTestDiskImageType(const wchar_t *filename, ATDiskImageFormat format, int subFormat) {
	...
	// SD basic read
	{
		...
		for(int i=0; i<16; ++i) {
			...
			diskImage->GetPhysicalSectorInfo(vsi.mFirstPhysSector, psi);
