...
bool ATPartitionDiskView::IsValidPhysicalSector(uint32 index) const {
	return index < mPartitionInfo.mSectorCount;
}
...
uint32 ATPartitionDiskView::GetNextPhysicalSector(uint32 physIndex) const {
	return physIndex;
}
