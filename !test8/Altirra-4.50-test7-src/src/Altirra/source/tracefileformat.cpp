...
AT_DEFINE_ENUM_TABLE_BEGIN(ATSavedTraceGroupType)
	{ ATSavedTraceGroupType::None,				"none" },
	{ ATSavedTraceGroupType::Log,				"log" },
AT_DEFINE_ENUM_TABLE_END(ATSavedTraceGroupType, ATSavedTraceGroupType::None)
